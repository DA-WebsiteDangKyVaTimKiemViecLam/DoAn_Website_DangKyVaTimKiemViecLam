...
('DN062', N'Công Ty TNHH Truyền thông Golden A',									N'Lầu 3, Aga Building, 72/24 Phan Đăng Lưu, Quận Phú Nhuận',						N'hr@goldena.vn!',									'07084283711',		'1998', N'TP.HCM',					'123456',N'Đã duyệt'),
('DN063', N'CÔNG TY TNHH Ê SU HAI',													N'24 Ấp Bắc, Phường 13, Quận Tân Bình',												N'tuyendung@esuworks.vn',							'07084283010',		'2006', N'TP.HCM',					'123456',N'Đã duyệt')
...
('BD061',N'Agency Golden A tuyển dụng Account Executive','DN062','L030',N'Gặp gỡ khách hàng để nhận brief và trình bày các ý tưởng của team cho khách.Hợp tác với team cho ra những proposal.Nhận plan dự án sẽ chạy và thực hiện điều phối nhân sự triển khai.Theo sát tiến độ của content, designer và advertiser - đảm bảo đúng timeline và KPI của KH đề ra.',N'Môi trường làm việc đầy kích thích, chưa có kinh nghiệm sẽ được đào tạo.Theo lý thuyết: Ngày làm 8 tiếng, thứ 7 & Chủ Nhật nghỉ.Lương và phúc lợi xứng đáng, bạn có năng lực thì thăng tiến vèo vèo là chuyện đương nhiên.',N'Account Executive',N'Không yêu cầu kinh nghiệm',N'22-25 tuổi',N'Thỏa thuận','10-11-2023',N'Có kiến thức về Digital Marketing và Digital Communication.Tiếng Anh giao tiếp, đọc hiểu tốt.Hiểu về Copywrite, Design, Ads để làm việc với team Execution.Có thêm các tài lẻ mang tính giải trí cao (ca hát nhảy múa, design, writing…) là một điểm cộng lớn.',N'Đã Duyệt'),
('BD062',N'TUYỂN 5 KỸ SƯ LẬP TRÌNH IT, IOT LÀM VIỆC TẠI NHẬT BẢN','DN063','L016',N'Sử dụng các ngôn ngữ lập trình (C, C++, C#, VB.net,…), các phần mềm lập trình PLC để viết chương trình điều khiển các dậy chuyền tự động hóa.Xây dựng hệ thống dự liệu thu thập và quản lí data hiệu quả hướng đến nâng cao năng suất sản xuất.Ứng dụng lập trình Iot,IT,.vào quản lí các yếu tố trong quy trình sản xuất như nhiệt độ phôi trog quá trình thổi định hình, dữ liệu hình ảnh từ các máy đo đạc, kiểm tra chất lượng…',N'Cơ hội nhận học bổng khuyến học lên đến 24 triệu VNĐ trong giai đoạn học tại Việt Nam.Hỗ trợ chi phí đi lại khi làm việc tại Nhật.Cơ hội nhận trợ cấp và đưa gia đình sang Nhật cùng sinh sống.Doanh nghiệp hỗ trợ tiền nhà ở và trợ cấp bằng cấp (nếu đạt được những bằng cấp theo yêu cầu).Điều chỉnh lương 1 lần/năm, thưởng 2 lần/năm.Được tham gia đầy đủ các chế độ bảo hiểm lao động, sức khỏe,...Hỗ trợ chi phí sinh hoạt tại Việt Nam trong lúc chờ xuất cảnh LÊN ĐẾN 4.000.000 VND (tối đa 48.000.000 VND/năm)',N'KỸ SƯ LẬP TRÌNH',N'Không yêu cầu kinh nghiệm',N'22-25 tuổi',N'Thỏa thuận','15-11-2023',N'Tốt nghiệp Đại học trở lên thuộc chuyên ngành IT, Cơ khí, Điện-Điện tử,… hoặc có yêu thích lĩnh vực IT.Có kiến thức về các nền tảng như Windows, Linux, iOS, Android.Có sức khỏe tốt, không mắc các bệnh truyền nhiễm.Có khả năng làm việc nhóm, có tinh thần cầu tiến và chịu được áp lực cao.',N'Đã Duyệt')
...
('BD061','AD002','11-11-2023'),
('BD062','AD002','16-11-2023')
